...
# ---------------------------------------------------------------------------- #
_C.MODEL.CRMASK = CN()
_C.MODEL.CRMASK.INSTANCE_LOSS_WEIGHT = 1.0
_C.MODEL.CRMASK.MASK_OUT_STRIDE = 4
_C.MODEL.CRMASK.MAX_PROPOSALS = -1
_C.MODEL.CRMASK.TOPK_PROPOSALS_PER_IM = -1
#local mask options
_C.MODEL.CRMASK.MASK_L = CN()
_C.MODEL.CRMASK.MASK_L.OUT_CHANNELS = 1
_C.MODEL.CRMASK.MASK_L.SIZE = 28
_C.MODEL.CRMASK.MASK_L.INTERP = True
_C.MODEL.CRMASK.NUM_MASK_CONVS = 4
_C.MODEL.CRMASK.VECTOR_MASK = True #get mask from two vector
# Global mask options
_C.MODEL.CRMASK.MASK_G = CN()
_C.MODEL.CRMASK.MASK_G.USE_GLOBAL = False
_C.MODEL.CRMASK.MASK_G.GLOBAL_CONTEXT = False 
_C.MODEL.CRMASK.MASK_G.OUT_CHANNELS = 8
_C.MODEL.CRMASK.MASK_G.STRIDES = 8 # p3
_C.MODEL.CRMASK.MASK_G.OUT_STRIDES = 4
# SVD mask options
_C.MODEL.CRMASK.SVD = CN()
_C.MODEL.CRMASK.SVD.TOPK = 3
_C.MODEL.CRMASK.SVD.MASK_SIZE = (14,14)
_C.MODEL.CRMASK.SVD.INTERP = False
_C.MODEL.CRMASK.SVD.DIRECT_MASK = False
_C.MODEL.CRMASK.SVD.GLOBAL_CONTEXT = False
_C.MODEL.CRMASK.SVD.MASK_BRANCH = False
_C.MODEL.CRMASK.SVD.MASK_MODE = 'cls' # 'cls' 'reg'
